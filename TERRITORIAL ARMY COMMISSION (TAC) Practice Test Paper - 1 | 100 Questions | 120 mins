FILENAME: TERRITORIAL ARMY COMMISSION (TAC) Practice Test Paper - 1 | 100 Questions | 120 mins.md
...
- (D) Tetanus
**Answer:** D
**Explanation:** All except Tetanus transmitted by insects/mosquitoes.
...
- (D) Ring
**Answer:** B
**Explanation:** Others are specific types of ornaments.
...
- (D) Nylon
**Answer:** B
**Explanation:** Cotton is natural fibre; others synthetic.
...
- (D) Bicycle : Pedal
**Answer:** C
**Explanation:** In others, second is essential functional part.

#### Q31. In a certain code, BASIC is written as DDULE. How is LEADER written in that code?
- (A) NGCFGI
- (B) NHCGGU
- (C) OGDFHT
- (D) OHDGHU
**Answer:** B
**Explanation:** Odd positions +2, even +3.

#### Q32. If TRUTH is coded as SUQSTVSUGI, then the code for FALSE will be
- (A) EGZBKMRDE
- (B) EGZKMRIDF
- (C) EGZBKMRTDF
- (D) FGZBKNRTDF
**Answer:** C
**Explanation:** Each letter replaced by preceding and following letters.

#### Q33. If 'paper' is called 'wood', 'wood' is called 'straw', 'straw' is called 'grass', 'grass' is called 'rubber' and 'rubber' is called 'cloth', what is the furniture made up of ?
- (A) Paper
- (B) Wood
- (C) Straw
- (D) Grass
**Answer:** C
**Explanation:** Furniture made of wood, which is called straw.

#### Q34. On another planet, the local terminology for 'earth', 'water', 'light', 'air' and 'sky' are 'sky, light', 'air, water' and 'earth' respectively. If someone is thirsty there, what would he drink?
- (A) Light
- (B) Air
- (C) Sky
- (D) Water
**Answer:** A
**Explanation:** Water called 'light' on the planet.

#### Q35. Pointing to a man on the stage, Rashi said, "He is the brother of the daughter of the wife of my husband." How is the man on the stage related to Rashi?
- (A) Son
- (B) Husband
- (C) Cousin
- (D) Nephew
**Answer:** A
**Explanation:** Wife of husband is Rashi; brother of daughter is son.

#### Q36. Introducing a man, a woman said, "His wife is the only daughter of my father." How is that man related to the woman?
- (A) Brother
- (B) Father-in-law
- (C) Maternal uncle
- (D) Husband
**Answer:** D
**Explanation:** Only daughter of woman's father is the woman herself.

#### Q37. Five persons are standing in a line. One of the two persons at the extreme ends is a professor and the other a business man. An advocate is standing to the right of a student. An author is to the left of the business man. The student is standing between the professor and the advocate. Counting from the left, the advocate is at which place?
- (A) 1st
- (B) 2nd
- (C) 3rd
- (D) 5th
**Answer:** C
**Explanation:** Arrangement: Professor, Student, Advocate, Author, Businessman. Advocate is 3rd.

#### Q38. A, B, C, D and E are five friends. A is shorter than B but taller than E. C is the tallest. D is shorter than B and taller than A. Who has two persons taller and two persons shorter than him/her?
- (A) A
- (B) B
- (C) C
- (D) D
**Answer:** D
**Explanation:** Order: E < A < D < B < C. D has two shorter, two taller.

#### Q39. Gopal starts from his house towards West. After walking a distance of 30 metres, he turned towards right and walked 20 metres. He then turned left and moving a distance of 10 metres, turned to his left again and walked 40 metres. He now turns to the left and walks 5 metres. Finally he turns to his left. In which direction is he walking now?
- (A) North
- (B) South
- (C) East
- (D) South-west
**Answer:** A
**Explanation:** Final direction after all turns is North.

#### Q40. Raju drives 25 km North and turns left and travels 5 km and reaches point 'O'. He, then turns right and covers another 5 km. Afterwards turns to East and drives 5 km. How much distance he has to travel to go back to the starting point?
- (A) 30 km
- (B) 20 km
- (C) 25 km
- (D) 35 km
...
**Answer:** D
**Explanation:** Scattering of light (Rayleigh scattering) causes reddish appearance at horizon.

#### Q42. Why is argon gas used along with tungsten wire in an electric bulb?
...
**Answer:** A
**Explanation:** Argon prevents oxidation and evaporation of tungsten filament.

#### Q43. Silver articles become black after some time when exposed to air because
...
**Answer:** C
**Explanation:** Formation of silver sulphide (tarnish).

#### Q44. The optical phenomenon that is primarily responsible for the observation of rainbow on a rainy day is
- (A) diffraction
- (B) interference
- (C) dispersion
- (D) reflection
**Answer:** C
**Explanation:** Dispersion of sunlight by water droplets.

#### Q45. Bright light is found to emit from photographer's flashgun. This brightness is due to the presence of which one of the following noble gases?
- (A) Argon
- (B) Xenon
- (C) Neon
- (D) Helium
**Answer:** B
**Explanation:** Xenon is used in flash lamps.

#### Q46. Dispersion process forms spectrum due to white light falling on a prism. The light wave with shortest wavelength
- (A) refracts the most
- (B) does not change the path
- (C) refracts the least
- (D) is reflected by the side of the prism
**Answer:** A
**Explanation:** Violet (shortest wavelength) bends most.

#### Q47. The main source of energy in sun is
- (A) nuclear fusion
- (B) nuclear fission
- (C) chemical reaction
- (D) mechanical energy
**Answer:** A
**Explanation:** Hydrogen to helium fusion.

#### Q48. The gas used in a refrigerator is
- (A) cooled down on flowing
- (B) heated up on flowing
- (C) cooled down when compressed
- (D) cooled down when expanded
**Answer:** D
**Explanation:** Refrigerant cools on expansion (Joule-Thomson effect).

#### Q49. The celsius temperature is a/an
- (A) relative temperature
- (B) absolute temperature
- (C) specific temperature
- (D) approximate temperature
**Answer:** A
**Explanation:** Celsius is relative scale; Kelvin is absolute.

#### Q50. What type of mixture is smoke?
- (A) Solid mixed with a gas
- (B) Gas mixed with a gas
- (C) Liquid mixed with a gas
- (D) Gas mixed with a liquid and a solid
**Answer:** A
**Explanation:** Aerosol: solid particles in gas.

#### Q51. An emulsion consists of
- (A) one liquid and one solid
- (B) one liquid and one gas
- (C) two liquids
- (D) two solids
**Answer:** C
**Explanation:** Colloidal dispersion of two immiscible liquids.

#### Q52. The chemical properties of an element depend upon
...
**Answer:** D
**Explanation:** Valence electrons determine chemical behavior.

#### Q53. What is the maximum number of states of matter?
- (A) Three
- (B) Five
- (C) Four
- (D) Variable
**Answer:** C
**Explanation:** Commonly solid, liquid, gas, plasma (four).

#### Q54. Which one of the following is the first enzyme to mix with food in the digestive tract?
- (A) Trypsin
- (B) Cellulose
- (C) Pepsin
- (D) Amylase
**Answer:** D
**Explanation:** Salivary amylase in mouth.

#### Q55. Which of the following classes of animals has/have three chambered heart?
- (A) Pisces and Amphibia
- (B) Amphibia and Reptilia
- (C) Reptilia only
- (D) Amphibia only
**Answer:** B
**Explanation:** Amphibians and most reptiles have three-chambered hearts.

#### Q56. Lysosome is formed from which of the following cell organelles?
- (A) Nucleus
- (B) Endoplasmic reticulum
- (C) Golgi bodies
- (D) Ribosomes
**Answer:** C
**Explanation:** Golgi apparatus forms lysosomes.

#### Q57. In which one of the following types of connective tissues in animals does fat get stored?
- (A) Adipocyte
- (B) Chondrocyte
- (C) Osteocyte
- (D) Reticulocyte
**Answer:** A
**Explanation:** Adipose tissue (adipocytes) stores fat.

#### Q58. Which Buddhist text contains an account of the Mauryan Emperor Ashoka?
- (A) Vinaya Pitaka
- (B) Sutta Pitaka
- (C) Abhidhamma Pitaka
- (D) Mahavamsa
**Answer:** D
**Explanation:** Mahavamsa chronicles Ashoka.

#### Q59. Patanjali was
- (A) a philosopher of the 'Yogachara' school
- (B) the author of a book on Ayurveda
- (C) a philosopher of the 'Madhyamika' school
- (D) the author of a commentary on Panini's San grammar
**Answer:** D
**Explanation:** Author of Mahabhashya on Panini grammar.

#### Q60. After the death of Shivaji, there was a fight for succession between
- (A) Shambhaji and the widow of Shivaji
- (B) Shambhaji and Bajirao
- (C) Rajaram and Shambhaji
- (D) None of them
**Answer:** C
**Explanation:** Rajaram and Shambhaji succession conflict.

#### Q61. The ruins of the Vijayanagara at Hampi were brought to light in 1800 by
- (A) Colonel Colin Mackenzie
- (B) Sir John Shore
- (C) Andrew Fraser
- (D) John Marshall
**Answer:** A
**Explanation:** Colonel Colin Mackenzie discovered ruins.

#### Q62. The Ghadar party, formed in the USA, was determined to start a revolt in India. Which among the following provinces did the party choose to begin its armed revolt?
- (A) Punjab
- (B) Bengal
- (C) United Provinces
- (D) Bihar
**Answer:** A
**Explanation:** Planned revolt in Punjab.

#### Q63. The social ideals of Mahatma Gandhi were first put forth in
- (A) Hind Swaraj
...
**Answer:** A
**Explanation:** Hind Swaraj outlines his ideals.

#### Q64. The only inscribed stone portrait of Emperor Ashoka has been found at
- (A) Sanchi
- (B) Amaravati
- (C) Kanaganahalli
- (D) Ajanta
**Answer:** C
**Explanation:** At Kanaganahalli stupa.

#### Q65. What do you mean by 'Demographic Dividend'?
...
**Answer:** A
**Explanation:** Benefit from large working-age population.

#### Q66. Most ozone gas (about 90%) is located in the atmospheric layer of
- (A) ionosphere
- (B) troposphere
- (C) stratosphere
- (D) mesosphere
**Answer:** C
**Explanation:** Ozone layer in stratosphere.

#### Q67. Which one of the following tribal groups found in the 'Blue Mountains'?
- (A) Lambadas
- (B) Gonds
- (C) Jarawas
- (D) Todas
**Answer:** D
**Explanation:** Todas in Nilgiri (Blue) Mountains.

#### Q68. Pir Panjal Range in the Himalayas is a part of:
- (A) Shiwalik
- (B) Trans Himalaya
- (C) Central Himalaya
- (D) Lesser Himalaya
**Answer:** D
**Explanation:** Part of Lesser (Middle) Himalayas.

#### Q69. The 'eye' of the cyclone has
...
**Answer:** A
**Explanation:** Calm center with low pressure, higher temp.

#### Q70. A nautical mile is equal to
- (A) 5060 feet
- (B) 5280 feet
- (C) 6060 feet
- (D) 6080 feet
