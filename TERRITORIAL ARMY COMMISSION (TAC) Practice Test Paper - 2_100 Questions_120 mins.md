...
### Q3. Which of the following diagrams indicates the best relation between Man, Workers and Garden?
...
- (D) Option D
**Answer:** (D)
**Explanation:** Some men can be workers while some workers can be men. Garden is a separate entity.
...
![Figure Q5: Venn Diagram with overlapping shapes](images/q5_venn_boys.png)
- (A) 1
- (B) 2
- (C) 6
- (D) 10
...
### Q6. In a row of boys, A is thirteenth from the left and D is seventeenth from the right. If in this row A is eleventh from the right then what is the position of D from the left?
- (A) 6th
- (B) 7th
- (C) 10th
- (D) 12th
...
### Q8. Kailash remembers that his brother Deepak's birthday falls after 20th May but before 28th May, while Geeta remembers that Deepak's birthday falls before 22nd May but after 12th May. On what date Deepak's birthday falls?
- (A) 20th May
- (B) 21st May
- (C) 22nd May
...
![Figure Q16: Number puzzle circle](images/q16_circle.png)
- (A) 11
- (B) 12
- (C) 22
- (D) 33
...
![Figure Q17: Square root pattern](images/q17_sqrt.png)
- (A) 21
- (B) 25
- (C) 35
- (D) 45
...
![Figure Q18: Fraction pattern](images/q18_fraction.png)
- (A) 16
- (B) 21
- (C) 61
- (D) 81
...
### Q29. How many triangles are there in the figure?
![Figure Q29: Triangle counting figure](images/q29_triangles.png)
- (A) 16
- (B) 22
- (C) 28
- (D) 32
...
![Figure Q30: Square counting grid](images/q30_squares.png)
- (A) 32
- (B) 30
- (C) 29
- (D) 28
...
**Answer:** (A)
**Explanation:** It increases the rate of reaction.
...
**Answer:** (A)
**Explanation:** Mixture of potassium iodide and common salt.
...
- (D) DNA
**Answer:** (A)
**Explanation:** Cell wall synthesis.

### Q51. The Fundamental Rights guaranteed in the Constitution of India can be suspended only by
